...
Stav: **COMPLETED_OFFLINE_REANALYSIS_WITH_EXPLICIT_LIMITATIONS**; skutočné hardvérové údaje: **áno**.
Plný ZIP archív: **NOT_CREATED_THIS_RUN**. Toto je offline prepočet pôvodného behu; merané FID ostáva v `../raw/` pri pôvodnom behu.
...
Zaúčtovaných fyzických úloh: **149**; riadkov porovnania: **83**. Riadky nie sú nezávislé opakovania jedinej metódy.

- **Rabi pilot:** perióda 152 µs, odhad 90° pulzu 38 µs; zhoda fitu nie je vernosťou brány.
- **B:** 10 párov blokov; medián absolútnej odchýlky frekvencie od zmrazenej pilotnej referencie: 8000 bodov 129 Hz, 16000 bodov 15.7 Hz. Pilotná referencia leží na okraji fit pásma. Plán dĺžky FID: MODEL_MISMATCH. Tieto odchýlky nedokazujú presnosť ani úsporu času kratšej akvizície.
- **F:** 3 odložené meracie bloky; medián komplexnej FID RMSE: unchanged 32.1, complex_TV 31.1, randomized_Hankel 26.1. Randomized Hankel mal nižšiu chybu v 3/3 párov. Neurónové porovnanie a interval spoľahlivosti chýbajú; nadradenosť nie je preukázaná.
...
- **B**: REFERENCE_INADEQUATE — Stored pilot frequency fit was clipped to its frozen component band; FID-length frequency accuracy has no valid independent reference. Saved B differences are diagnostic only; echo timing remains unverified
- **C**: UNVERIFIED_TIMING — Multiple H segments failed the live timing contract; no GRAPE task submitted
- **D**: DEPENDENCY_FAILED — ValueError: Effective D acquisition-frequency fit and pilot reference both hit frozen band edge: fit=-1570.7, pilot=-1570.7, band=[-1810.7, -1570.7] Hz; see D_effective_pilot_diagnostic.json
- **E**: DEPENDENCY_FAILED — Generator trained and compared on held-out simulated 1q gates; independent physical gate/readout measurements absent
...
| B | diagnostic_8000 | fixed_16000 | B_b00_diagnostic_8000 | 0 | 1 | 14.854 | 138.19 | [—, —] | 3 | REFERENCE_INADEQUATE |
| B | fixed_16000 | fixed_16000 | B_b00_fixed_16000 | 0 | 1 | 15.053 | 14.143 | [—, —] | 3 | REFERENCE_INADEQUATE |
...
| B | fixed_16000 | fixed_16000 | B_b01_fixed_16000 | 1 | 1 | 15.668 | 16.693 | [—, —] | 3 | REFERENCE_INADEQUATE |
| B | diagnostic_8000 | fixed_16000 | B_b01_diagnostic_8000 | 1 | 1 | 14.65 | 119.14 | [—, —] | 3 | REFERENCE_INADEQUATE |
...
| B | diagnostic_8000 | fixed_16000 | B_b02_diagnostic_8000 | 2 | 1 | 13.849 | 154.9 | [—, —] | 3 | REFERENCE_INADEQUATE |
| B | fixed_16000 | fixed_16000 | B_b02_fixed_16000 | 2 | 1 | 15.06 | 7.4656 | [—, —] | 3 | REFERENCE_INADEQUATE |
...
| B | fixed_16000 | fixed_16000 | B_b03_fixed_16000 | 3 | 1 | 15.059 | 10.781 | [—, —] | 3 | REFERENCE_INADEQUATE |
| B | diagnostic_8000 | fixed_16000 | B_b03_diagnostic_8000 | 3 | 1 | 13.253 | 58.93 | [—, —] | 3 | REFERENCE_INADEQUATE |
...
| B | diagnostic_8000 | fixed_16000 | B_b04_diagnostic_8000 | 4 | 1 | 11.852 | 30.95 | [—, —] | 3 | REFERENCE_INADEQUATE |
| B | fixed_16000 | fixed_16000 | B_b04_fixed_16000 | 4 | 1 | 11.451 | 37.761 | [—, —] | 3 | REFERENCE_INADEQUATE |
...
| B | fixed_16000 | fixed_16000 | B_b05_fixed_16000 | 5 | 1 | 13.071 | 32.414 | [—, —] | 3 | REFERENCE_INADEQUATE |
| B | diagnostic_8000 | fixed_16000 | B_b05_diagnostic_8000 | 5 | 1 | 12.053 | 7.8444e-11 | [—, —] | 3 | REFERENCE_INADEQUATE |
...
| B | diagnostic_8000 | fixed_16000 | B_b06_diagnostic_8000 | 6 | 1 | 11.679 | 151.37 | [—, —] | 3 | REFERENCE_INADEQUATE |
| B | fixed_16000 | fixed_16000 | B_b06_fixed_16000 | 6 | 1 | 12.26 | 19.16 | [—, —] | 3 | REFERENCE_INADEQUATE |
...
| B | fixed_16000 | fixed_16000 | B_b07_fixed_16000 | 7 | 1 | 11.491 | 25.642 | [—, —] | 3 | REFERENCE_INADEQUATE |
| B | diagnostic_8000 | fixed_16000 | B_b07_diagnostic_8000 | 7 | 1 | 10.449 | 204.33 | [—, —] | 3 | REFERENCE_INADEQUATE |
...
| B | diagnostic_8000 | fixed_16000 | B_b08_diagnostic_8000 | 8 | 1 | 9.8616 | 160.81 | [—, —] | 3 | REFERENCE_INADEQUATE |
| B | fixed_16000 | fixed_16000 | B_b08_fixed_16000 | 8 | 1 | 11.25 | 14.687 | [—, —] | 3 | REFERENCE_INADEQUATE |
...
| B | fixed_16000 | fixed_16000 | B_b09_fixed_16000 | 9 | 1 | 10.857 | 10.201 | [—, —] | 3 | REFERENCE_INADEQUATE |
| B | diagnostic_8000 | fixed_16000 | B_b09_diagnostic_8000 | 9 | 1 | 9.6398 | 81.118 | [—, —] | 3 | REFERENCE_INADEQUATE |
